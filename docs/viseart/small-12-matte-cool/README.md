...
![Shade 2 Sand](./slices/02_Sand.png)
...
![Shade 3 Seashell](./slices/03_Seashell.png)
...
![Shade 4 Lilac](./slices/04_Lilac.png)
...
![Shade 5 Shoreline](./slices/05_Shoreline.png)
...
![Shade 8 Lupine](./slices/08_Lupine.png)
...
![Shade 9 Ghirardelli](./slices/09_Ghirardelli.png)
...
![Shade 10 Elk](./slices/10_Elk.png)
...
![Shade 11 Bluebells](./slices/11_Bluebells.png)
...
![Shade 12 Iris](./slices/12_Iris.png)

Use: All over tone for all skin types, use as a soft eyeliner for light to medium tones.

##### 色号 12：鸢尾紫蓝 (Iris) —— Deep purple blue matte finish.
用途：适合所有肤色的大面积铺色；可作为浅至中等肤色的柔和眼线。
